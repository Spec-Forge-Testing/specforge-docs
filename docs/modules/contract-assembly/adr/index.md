# Contract Assembly — Decision records

Decisions taken while building `contract_assembly` that are not obvious from
...
| File | Stage | Covers |
| --- | --- | --- |
| [foundations.md](foundations.md) | package | What the package is called and why |
...
| [ADR-064](foundations.md#adr-064) | package | The contract module is `contract_assembly` |
